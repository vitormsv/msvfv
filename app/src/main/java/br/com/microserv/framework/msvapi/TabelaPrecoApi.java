...
public class TabelaPrecoApi extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        // region Obtendo dados do servidor e gravando na tabela TabelaPreco
        try {
            ...
            for (int i = 0; i < _jsonArray.length(); i++) {
                ...
                // obtendo um objeto tpTabelaPreco
                tpTabelaPreco _tpTabelaPreco = new tpTabelaPreco();
                _tpTabelaPreco.fillByJsonObject(_jsonObject);

                // inserindo o objeto _tpEmpresa na tabela TabelaPreco
                _dbTabelaPreco.insert(_tpTabelaPreco);
    ...
    // region TabelaPrecoApi
    public TabelaPrecoApi(
            Context context,
            String ip,
            String vendedor,
            int indice,
