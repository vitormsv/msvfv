...
public class BIAnoMovimento extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        tpBIAnoMovimento _tp1 = new tpBIAnoMovimento();
        _tp1._id = 1;
        _tp1.Ano = 2019;
        _lstOut.add(_tp1);
        ...
        try {
            ...
            _url = "http://{ip}/api/bi/anomovimento/{vendedor}";
            ...
            for (int i = 0; i < _jsonArray.length(); i++) {
                ...
                tpBIAnoMovimento _tpBIAnoMovimento = new tpBIAnoMovimento();
                _tpBIAnoMovimento.fillByJsonObject(_jsonObject);
                // endregion
