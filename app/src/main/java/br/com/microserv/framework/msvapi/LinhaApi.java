...
public class LinhaApi extends AsyncTask<Void, Void, Void> {
    ...
    private String _url = "http://{ip}/api/produto/linha";
    ...
    protected Void doInBackground(Void... params) {
        ...
        // region Obtendo dados do servidor e gravando na tabela Linha
        try {
            ...
            for (int i = 0; i < _jsonArray.length(); i++) {
                ...
                // obtendo um objeto tpLinha
                tpLinha _tpLinha = new tpLinha();
                _tpLinha.fillByJsonObject(_jsonObject);

                // inserindo o objeto _tpEmpresa na tabela Linha
                _dbLinha.insert(_tpLinha);
