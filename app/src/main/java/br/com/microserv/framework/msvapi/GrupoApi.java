...
public class GrupoApi extends AsyncTask<Void, Void, Void> {
    ...
    private String _url = "http://{ip}/api/produto/grupo";
    ...
    protected Void doInBackground(Void... params) {
        ...
        // region Obtendo dados do servidor e gravando na tabela Grupo
        try {
            ...
            for (int i = 0; i < _jsonArray.length(); i++) {
                ...
                // obtendo um objeto tpGrupo
                tpGrupo _tpGrupo = new tpGrupo();
                _tpGrupo.fillByJsonObject(_jsonObject);

                // inserindo o objeto _tpEmpresa na tabela Grupo
                _dbGrupo.insert(_tpGrupo);
