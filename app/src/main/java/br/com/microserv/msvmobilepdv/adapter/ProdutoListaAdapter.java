...
public class ProdutoListaAdapter extends BaseAdapter {
    ...
    ArrayList<tpProduto> _items = null;


    public ProdutoListaAdapter(Context context, ArrayList<tpProduto> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tpProduto _tp = _items.get(position);
        ...
        _txtUnidadeMedida.setText(_tp.UnidadeMedida + " " + String.valueOf(_tp.PackQuantidade) );

        // Preço do produto
        _txtProdutoPreco = (TextView) _view.findViewById(R.id.txtProdutoPreco);
        _txtProdutoPreco.setText(MSVUtil.doubleToText("R$", 0));

        if (_tp.TabelaPrecoProduto != null) {
            _txtProdutoPreco.setText(MSVUtil.doubleToText("R$", _tp.TabelaPrecoProduto.Preco));
        }
