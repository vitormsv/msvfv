...
public class GrupoDialogSearchAdapter extends BaseAdapter {

    Context _context = null;
    ArrayList<tpGrupo> _items = null;

    int _pos = -1;

    public GrupoDialogSearchAdapter(Context context, ArrayList<tpGrupo> items) {
