...
public class LinhaDialogSearchAdapter extends BaseAdapter {

    Context _context = null;
    ArrayList<tpLinha> _items = null;

    int _pos = -1;

    public LinhaDialogSearchAdapter(Context context, ArrayList<tpLinha> items) {
