...
public class TabelaPrecoDialogSearchAdapter extends BaseAdapter {

    Context _context = null;
    ArrayList<tpTabelaPreco> _items = null;

    int _pos = -1;

    public TabelaPrecoDialogSearchAdapter(Context context, ArrayList<tpTabelaPreco> items) {
