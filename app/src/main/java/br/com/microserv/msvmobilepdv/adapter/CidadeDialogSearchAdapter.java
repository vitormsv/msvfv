...
public class CidadeDialogSearchAdapter extends BaseAdapter {

    Context _context = null;
    ArrayList<tpCidade> _items = null;

    int _pos = -1;

    public CidadeDialogSearchAdapter(Context context, ArrayList<tpCidade> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        _row1 += _items.get(position).EstadoSigla;
        _row1 += " - ";
