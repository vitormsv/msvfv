...
public class RegiaoDialogSearchAdapter extends BaseAdapter {

    Context _context = null;
    ArrayList<tpRegiao> _items = null;

    int _pos = -1;

    public RegiaoDialogSearchAdapter(Context context, ArrayList<tpRegiao> items) {
