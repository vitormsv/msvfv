...
public class CondicaoPagamentoDialogSearchAdapter extends BaseAdapter {

    Context _context = null;
    ArrayList<tpCondicaoPagamento> _items = null;

    int _pos = -1;

    public CondicaoPagamentoDialogSearchAdapter(Context context, ArrayList<tpCondicaoPagamento> items) {
