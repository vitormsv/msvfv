...
public class PedidoMobileProdutoAdapter extends BaseAdapter {

    Context _context = null;
    ArrayList<tpPedidoMobileItem> _items = null;

    int _pos = -1;

    public PedidoMobileProdutoAdapter(Context context, ArrayList<tpPedidoMobileItem> items) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        tpPedidoMobileItem _tp = _items.get(position);
        // endregion
        ...
        if (convertView == null) {
            ...
            _view = _li.inflate(R.layout.row_pedido_mobile_produto_adapter, parent, false);
        } else {
            _view = convertView;
        }
        // endregion
        ...
        _txtProdutoCodigo.setText(_tp.Produto.Codigo);
        // endregion

        // region Descrição do produto
        _txtProdutoDescricao = (TextView) _view.findViewById(R.id.txtProdutoDescricao);
        _txtProdutoDescricao.setText(_tp.Produto.Descricao);
        // endregion

        // region Quantidade do produto por embalagem
        _aux = _tp.Produto.UnidadeMedida + " - " + String.valueOf(_tp.Produto.PackQuantidade);
        ...
        if (_tp.Produto.PermiteDecimal == 0) {
            _txtVendaQuantidade.setText(String.valueOf(MSVUtil.parseInt(_tp.UnidadeVendaQuantidade)));
        } else {
            _txtVendaQuantidade.setText(MSVUtil.doubleToText(_tp.UnidadeVendaQuantidade));
        }
        // endregion
