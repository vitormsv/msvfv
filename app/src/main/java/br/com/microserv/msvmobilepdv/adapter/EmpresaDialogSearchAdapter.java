...
public class EmpresaDialogSearchAdapter extends BaseAdapter {

    Context _context = null;
    ArrayList<tpEmpresa> _items = null;

    int _pos = -1;

    public EmpresaDialogSearchAdapter(Context context, ArrayList<tpEmpresa> items) {
